...
static uart_config_t default_config = {
...
int pl011_uart_init_config(const uart_config_t *config)
{
    ...
    switch (config->data_bits) {
        case UART_DATA_5BITS: lcrh |= LCRH_WLEN_5; break;
        case UART_DATA_6BITS: lcrh |= LCRH_WLEN_6; break;
        case UART_DATA_7BITS: lcrh |= LCRH_WLEN_7; break;
        case UART_DATA_8BITS: lcrh |= LCRH_WLEN_8; break;
    }
